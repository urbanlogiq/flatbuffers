...
impl<'a> FloatingPoint<'a> {
  ...
  pub fn unpack(&self) -> FloatingPointT {
...
pub struct FloatingPointT {
  pub precision: Precision,
}
impl Default for FloatingPointT {
  fn default() -> Self {
    Self {
      precision: Precision::HALF,
    }
...
impl FloatingPointT {
  ...
  ) -> flatbuffers::WIPOffset<FloatingPoint<'b>> {
    let precision = self.precision;
    FloatingPoint::create(_fbb, &FloatingPointArgs{
      precision,
    })
  }
}
